...
#   currentlyInfected["severeImpact"]["severeCasesByRequestedTime"] = 0.15 * currentlyInfected["severeImpact"]["infectionsByRequestedTime"]
  ...
  currentlyInfected["impact"]["dollarsInFlight"] = (currentlyInfected["impact"]["infectionsByRequestedTime"] * data['region']['avgDailyIncomePopulation']*data['region']['avgDailyIncomeInUSD']  * num_days)
  currentlyInfected["severeImpact"]["dollarsInFlight"] = (currentlyInfected["severeImpact"]["infectionsByRequestedTime"]  * data['region']['avgDailyIncomePopulation']*data['region']['avgDailyIncomeInUSD']  * num_days)
